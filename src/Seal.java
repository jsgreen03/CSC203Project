...
public class Seal extends AnimationEntity{

    public static final String QUAKE_KEY = "quake";

    public Seal(String id, Point position, List<PImage> images, int actionPeriod, int animationPeriod)
    {
    ...
    public static boolean withinReach(Point pt1, Point pt2) {
